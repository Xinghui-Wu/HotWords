...
public class Dictionary {
	private static HashMap<String, Word> dictionary = new HashMap<String, Word>();				//HashMap存储汉语词典
	private static HashMap<String, Double> IDF = new HashMap<String, Double>();					//HashMap存储TF-IDF预设词典
	private static int id = 0;																												//汉语词典中的词语个数
